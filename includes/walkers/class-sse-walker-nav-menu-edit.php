 ...
 * 
**/
class SSE_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$classes = array(
			...
			'menu-item-edit-' . esc_attr( ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? 'active' : 'inactive' ),
		);
			...
			<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
				...
				<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
					<!-- Settings -->
						...
						<!-- ShapeShifter -->
							<?php do_action( 'sse_nav_menu_item_edit', $item, $depth, $args, $id, $classes ); ?>
